...
<div class="bg-light min-vh-100">
    <div class="container-fluid py-4">
        ...
        <?php if(session('success')): ?>
            <div class="alert alert-success rounded-4 shadow-sm"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if(session('error')): ?>
            <div class="alert alert-danger rounded-4 shadow-sm"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control rounded-pill" placeholder="Search student...">
                                <button class="btn btn-primary rounded-pill ms-2 px-4"><i class="bi bi-search"></i></button>
                            </div>
                        </div>

                        <div class="col-md-2 text-end">
                            <a href="<?php echo e(route('admin.applications.index')); ?>" class="btn btn-outline-primary rounded-pill w-100">
        ...
        <div class="card border-0 shadow-lg rounded-4">
            <div class="card-header bg-white d-flex justify-content-between align-items-center p-4">
                <h3 class="fw-bold fs-4 text-primary">
                    ...
                    <span class="badge bg-primary ms-2"><?php echo e($applications->total()); ?></span>
                </h3>
                ...
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <form id="bulkActionForm" action="<?php echo e(route('admin.applications.bulk-action')); ?>" method="POST" class="d-none">
                        <?php echo csrf_field(); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"><input type="checkbox" class="application-checkbox" value="<?php echo e($app->id); ?>"></td>
                                <td><strong>#<?php echo e($app->id); ?></strong></td>
                                <td><strong><?php echo e($app->user->name); ?></strong><br><small class="text-muted"><?php echo e($app->user->email); ?></small></td>
                                <td><strong><?php echo e($app->program->code); ?></strong><br><small class="text-muted"><?php echo e($app->program->name); ?></small></td>
                                <td>
                                    <?php if($app->status == 'approved'): ?> <span class="badge bg-success">Approved</span>
                                    <?php elseif($app->status == 'rejected'): ?> <span class="badge bg-danger">Rejected</span>
                                    <?php elseif($app->status == 'under_review'): ?> <span class="badge bg-warning text-dark">Under Review</span>
                                    <?php else: ?> <span class="badge bg-info text-dark">Submitted</span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e($app->created_at->format('M d, Y')); ?></td>
                                <td class="text-center">
                                    <a href="<?php echo e(route('admin.applications.show', $app->id)); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3">
...
<div class="modal fade" id="bulkInterviewModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-4 shadow">
            ...
            <form id="bulkInterviewForm" action="<?php echo e(route('admin.applications.bulk-interview')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PMLS\projects\ug-admission-system\resources\views/admin/applications/index.blade.php ENDPATH**/ ?>