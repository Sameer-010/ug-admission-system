...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow sticky-top">
        <div class="container py-2">
            <a class="navbar-brand d-flex align-items-center" href="/">
                <img src="<?php echo e(asset('images/ug-logo.png')); ?>" alt="UG Logo" height="70" class="me-3">
                <div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-3">
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item">
                            <a class="btn btn-outline-primary rounded-pill px-4" href="<?php echo e(route('dashboard')); ?>">
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="btn btn-outline-primary rounded-pill px-4" href="<?php echo e(route('login')); ?>">
                                <i class="bi bi-box-arrow-in-right me-2"></i>Login
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-ug-blue rounded-pill px-5 py-2 shadow-lg" href="<?php echo e(route('register')); ?>">
                ...
                <div class="col-lg-6">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <div class="d-flex gap-3 flex-wrap">
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-warning btn-lg px-5 py-3 rounded-pill shadow-lg fw-bold fs-5">
                                <i class="bi bi-pencil-square me-2"></i>Start Application
                            </a>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-lg px-5 py-3 rounded-pill fw-semibold fs-5">
                                <i class="bi bi-person-circle me-2"></i>Student Login
                            </a>
                        </div>
                    <?php else: ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-warning btn-lg px-5 py-3 rounded-pill shadow-lg fw-bold fs-5">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-lg rounded-5 overflow-hidden h-100">
                    ...
                    <div class="card-body p-5">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-ug-blue w-100 py-3 rounded-pill fs-5 fw-bold shadow">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-lg rounded-5 overflow-hidden h-100 position-relative" style="transform: scale(1.05); z-index: 2;">
                    ...
                    <div class="card-body p-5">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-success w-100 py-3 rounded-pill fs-5 fw-bold shadow">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-lg rounded-5 overflow-hidden h-100">
                    ...
                    <div class="card-body p-5">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-warning w-100 py-3 rounded-pill fs-5 fw-bold shadow">
        ...
        <div class="container py-5">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5 text-center">
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-warning btn-lg px-5 py-4 rounded-pill shadow-lg fw-bold">
    ...
    <footer class="bg-dark text-white py-5">
        <div class="container py-4">
            <div class="row g-5">
                <div class="col-lg-4">
                    <img src="<?php echo e(asset('images/ug-logo.png')); ?>" alt="UG Logo" height="90" class="mb-4">
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-3"><a href="<?php echo e(route('register')); ?>" class="text-white-50 text-decoration-none fs-5"><i class="bi bi-chevron-right me-2"></i>Apply</a></li>
...
</html><?php /**PATH C:\Users\PMLS\projects\ug-admission-system\resources\views/welcome.blade.php ENDPATH**/ ?>