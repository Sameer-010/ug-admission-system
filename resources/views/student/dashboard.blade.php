                            ...
                            <table class="table align-middle table-hover">
                                ...
                                @foreach($applications as $application)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $application->program->name }}<br>
                                            <small class="text-muted">{{ $application->program->code }}</small>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if($application->challan_pdf)
                                                <a href="{{ asset('storage/'.$application->challan_pdf) }}"
                                                   target="_blank"
                                            ...
                                            <!-- Upload Paid Challan -->
                                            @if($application->challan_status === 'pending')
                                                <a href="{{ route('student.application.documents', $application->id) }}"
                                    ...
                                    <div class="card-body p-4">
                                        <ul class="list-unstyled mb-4">
                                            <li class="mb-2">
                                                ...
                                                <strong>{{ $program->total_seats }}</strong> Total Seats
                                            </li>
                                            <li class="mb-2">
                                                <i class="bi bi-clock-fill text-primary me-2"></i>
                                                <strong>{{ $program->duration_years }}</strong> Years Duration
                                            </li>
                                            <li class="mb-2">
                                        ...
                                        <a href="{{ route('student.application.create', ['program' => $program->id]) }}"
