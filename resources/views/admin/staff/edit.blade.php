            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-lg rounded-4">
                    ...
                    <div class="card-body p-4 p-md-5">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control rounded-pill" 
                                               placeholder="Enter full name" required value="{{ old('name', $staff->name) }}">
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="phone" class="form-control rounded-pill" 
                                               placeholder="Enter phone number" required value="{{ old('phone', $staff->phone) }}">
                                    </div>
                                    @error('phone')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" class="form-control rounded-pill" 
                                               placeholder="Enter email address" required value="{{ old('email', $staff->email) }}">
                                    </div>
                                    @error('email')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                        ...
                        <!-- Delete Form -->
                        <form id="delete-form-{{ $staff->id }}" action="{{ route('admin.staff.destroy', $staff->id) }}" method="POST" class="d-none">
                            @csrf
                            @method('DELETE')
                        </form>
                    </div>
