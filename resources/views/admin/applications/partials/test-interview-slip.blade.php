...
<div class="container">
    ...
    <div class="card">
        ...
        <table>
            ...
            <tr>
                <th>Program</th>
                <td>{{ $program->code }} — {{ $program->name }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="card">
        ...
        <table>
            <tr>
                <th>Date</th>
                <td>{{ \Carbon\Carbon::parse($test_date)->format('M d, Y') }}</td>
            </tr>
            <tr>
                <th>Time</th>
                <td>{{ \Carbon\Carbon::parse($test_time)->format('h:i A') }}</td>
            </tr>
            <tr>
                <th>Venue</th>
                <td>{{ $test_venue }}</td>
    ...
    <div class="card">
        ...
        <table>
            <tr>
                <th>Date</th>
                <td>{{ \Carbon\Carbon::parse($interview_date)->format('M d, Y') }}</td>
            </tr>
            <tr>
                <th>Time</th>
                <td>{{ \Carbon\Carbon::parse($interview_time)->format('h:i A') }}</td>
            </tr>
            <tr>
                <th>Venue</th>
