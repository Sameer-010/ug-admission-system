                    ...
                    <div class="card-body p-4 p-md-5">
                        <div class="row align-items-center">
                            <div class="col-lg-8">
                                ...
                                <h1 class="display-5 display-md-4 fw-bold text-white mb-3">Edit {{ $program->name }}</h1>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="code" class="form-control rounded-pill" value="{{ $program->code }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control rounded-pill" value="{{ $program->name }}" required>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <label class="form-label fw-bold">Description</label>
                                    <textarea name="description" class="form-control rounded-3" rows="4" placeholder="Enter program description...">{{ $program->description }}</textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="total_seats" class="form-control rounded-pill" value="{{ $program->total_seats }}" min="1" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="card border-0 bg-light">
                                        <div class="card-body">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="is_active" id="is_active" {{ $program->is_active ? 'checked' : '' }}>
